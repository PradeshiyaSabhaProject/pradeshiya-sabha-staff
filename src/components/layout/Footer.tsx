...
const Footer: React.FC = () => {
  ...
  const importantLinks = [
    { label: 'ශ්‍රී ලංකා රජයේ නිල අන්තර්ජාල ද්වාරය', href: '#' },
    { label: 'නාගරික සංවර්ධන අධිකාරිය', href: '#' },
    { label: 'රාජ්‍ය තොරතුරු කේන්ද්‍රය', href: '#' },
    { label: 'ආරක්ෂක අමාත්‍යාංශය', href: '#' },
    { label: 'පළාත් සභා හා පළාත් පාලන අමාත්‍යාංශය', href: '#' },
    {
      label: 'රාජ්‍ය පරිපාලන හා පළාත් පාලන අමාත්‍යාංශය',
      href: '#',
    },
  ]
