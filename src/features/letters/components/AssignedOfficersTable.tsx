        ...
        <table className="w-full text-left border-collapse min-w-[850px]">
          <thead>
            <tr className="bg-gray-100 border-y border-gray-300 text-[11px] font-bold text-gray-600 uppercase tracking-wider">
              ...
              <th className="py-3 px-6">ASSIGNED CATEGORY</th>
              <th className="py-3 px-6 text-center">ASSIGNED LETTERS</th>
              <th className="py-3 px-6 text-center">COMPLETED LETTERS</th>
              <th className="py-3 px-6 text-center">REMAINING LETTERS</th>
          ...
          <tbody className="divide-y divide-gray-200 text-sm">
            {filteredOfficers.map((officer) => (
              <tr key={officer.id} className="hover:bg-gray-50/60 transition-colors">
                <td className="py-3.5 px-6 font-bold text-gray-800 whitespace-nowrap font-mono">{officer.refId}</td>
                ...
                <td className="py-3.5 px-6 font-semibold text-gray-700 whitespace-nowrap">{officer.role}</td>
                <td className="py-3.5 px-6 font-semibold text-gray-700 whitespace-nowrap">
                  <span className="text-xs px-2.5 py-0.5 rounded bg-gray-100 border border-gray-200 text-gray-700">
                    {officer.assignedCategory}
                  </span>
                </td>
                <td className="py-3.5 px-6 text-center font-semibold text-gray-700 whitespace-nowrap">{officer.assignedLetters}</td>
                <td className="py-3.5 px-6 text-center font-semibold text-green-700 whitespace-nowrap">{officer.completedLetters}</td>
                <td className="py-3.5 px-6 text-center font-bold text-[#A31736] whitespace-nowrap">{officer.remainingLetters}</td>
