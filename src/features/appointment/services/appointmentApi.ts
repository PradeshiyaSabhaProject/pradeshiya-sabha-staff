...
const addRecords = (status: AppointmentStatus, count: number) => {
  for (let i = 0; i < count; i++) {
    ...
    MOCK_APPOINTMENTS.push({
      ...
      service: service,
      dateTime: `2023-07-${day} ${hour}.${minute} ${ampm}`,
