    ...
    <div className="space-y-6 text-left pb-8 animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          <Link
            to="/finances/reports"
            className="border border-[#A31736] bg-rose-50 hover:bg-[#A31736] text-[#A31736] hover:text-white text-xs font-bold px-3 py-2 rounded transition-colors uppercase tracking-wider flex items-center gap-1.5 cursor-pointer shadow-xs"
          >
